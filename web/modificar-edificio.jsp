<%-- 
    Document   : modificar-edificio
    Created on : 07-02-2015, 09:31:45 PM
    Author     : Natalia
--%>
...
<html>
    ...
    <head>
        ...
        <title>Usuario | MODIFICAR EDIFICIO </title> 
                                ...
                                <div class="col-sm-12 agregar-edificio"> 
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ubicacion_medidores"   class="form-control" required="true" value="<c:out value="${deed.ubicacionMedidores}"/>"
                                                   onChange="javascript:while ('' + this.value.charAt(0) == ' ')this.value = this.value.substring(1, this.value.length);"/>
                                        </div> 
                                        <div class="form-group">
                                            <label for="potencia_real">Potencia ingreso (kW)</label>
                                            <input type="text" name="potencia_real" maxlength="3" class="form-control" required="true" value="<c:out value="${ed.potenciaReal}"/>"
                                                   onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                       this.value = this.value.substring(1, this.value.length);"/>
                                        </div>
                                        <div class="form-group">          
                                            <table table-bordered table-striped table-condensed>
                                                <tr style="">
                                                    ...
                                                    <td style="padding-left: 30px!important; width: 200px!important;">
                                                        <input type="text" name="fecha_inspeccion" id="f_date1"  class="form-control-fecha"  value="<c:out value="${fe.fechaInspeccion}"/> ">
                                                    </td><td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="fecha_primera" id="f_date2" class="form-control-fecha"  value="<c:out value="${fe.fechaPrimera}"/>">
                                                    </td><br><td>
                                                    <button id="f_btn1">...</button>
                                                </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="fecha_segunda" id="f_date3"   class="form-control-fecha"  value="<c:out value="${fe.fechaSegunda}"/>">
                                                    </td><br><td>
                                                    <button id="f_btn1">...</button>
                                                </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="fecha_cierre"  id="f_date4"  class="form-control-fecha" value="<c:out value="${fe.fechaCierre}"/>">                                          
                                                    </td><td>
                                                        <button id="f_btn1">...</button>
                                                    </td>  
                                                </tr>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="padding-radio">  
                                                <div class="radio">                             
                                                    <input  type="radio" name="despiche" value="T_de prueba" <c:if test="${deed.despiche == 'T_de prueba'}">checked</c:if>>T- de prueba 
                                                        <div class="radio">
                                                            <input  type="radio" name="despiche" value="Despiche" <c:if test="${deed.despiche == 'Despiche'}">checked</c:if>>      Despiche 
                                                            <div class="radio">
                                                                <input  type="radio" name="despiche" value="Otros" <c:if test="${deed.despiche == 'Otros'}">checked</c:if>>            Otros  
                                                            </div>
                                                        </div>
                                                    </div>         
                                                </div>
                                            ...
                                            <div class="form-group">          
                                                <table table-bordered table-striped table-condensed>
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 30px!important; width: 150px!important;">
                                                            <input type="text" name="cant_departamentos" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantDepartamentos}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_casas" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantCasas}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_locales" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantLocales}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_areas" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantAreas}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_lavanderias" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantLavanderias}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_pisos" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantPisos}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_conductos" maxlength="3" required="true" class="form-control" 
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"
                                                               value="<c:out value="${ed.cantConductos}"/>"/>
                                                    </td>                                            
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td style="padding-left: 30px!important;">
                                                        <input type="text" name="cant_calderas" maxlength="3" required="true" class="form-control" value="<c:out value="${ed.cantCalderas}"/>"
                                                               onChange="javascript:while ('' + this.value.charAt(0) == ' ')
                                                                                   this.value = this.value.substring(1, this.value.length);"/>
                                                    </td>                                            
                                                </tr>
