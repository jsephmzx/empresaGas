<%-- 
    ...
    Created on : 08-03-2015, 03:42:28 PM
    Author     : Natalia
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 agregar-admin-vendedor centrar2 color-blanco">
                                <h4><b>MODIFICAR CONTRASEÑA</b></h4>
                                <div class="form-group">
                                    <c:if test="${agregar5 == 5}">
                                        <div class="alert alert-danger">
                                            <label style="color: #e45c00 !important;"><h5>*  Contraseña anterior incorrecta</h5></label>
                                        </div>
                                    </c:if>
                                    <c:if test="${agregar2 == 2}">
                                        <div class="alert alert-danger">
                                            <label style="color: #e45c00 !important;"><h5>*  Contraseñas distintas</h5></label>
                                        </div>
                                    </c:if>
                                    <c:if test="${password == 1}">
                                        <div class="alert alert-success color-negro">
                                            <h5>Contraseña modificada Satisfactoriamente</h5>
                                        </div>
                                    </c:if>  
                                </div>
                                <form action="/Proyectoempresa/contrasenaChangeServlet" role="form" method="post"> <%--fillContrasenaServlet en el boton de ingreso --%>
                                    <div class="col-lg-7" >                                                                                      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="password" class="form-control" name="contrasenaA" required="true"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div  hidden="true" class="form-group">
                                            <input  type="text" name="contrasenaBD" class="form-control" value="<c:out  value="${us.contrasena }" />">                                
                                        </div> 
                                        <div  hidden="true" class="form-group">
                                            <input  type="text" name="tipo_usuario" value="<c:out  value="${us.tipoUsuario}"/>">                                
                                        </div> 
                                        <div hidden="true" class="form-group">
                                            <input type="text" class="form-control" name="email_usuario" value="<c:out value="${us.emailUsuario}"/>"/>
                                        </div>
                                        <div hidden="true" class="form-group">
                                            <input type="text" class="form-control" name="id_usuario" value="<c:out value="${us.idUsuario}"/>"/>
                                        </div>
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-default btn-md" value="Modificar Contraseña" />
                                        </div>                                  
                                    </div>
                                </form>
                                <div class="col-lg-7">
