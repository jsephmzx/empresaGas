...
<html>
    <head>
        ...
        <title>Administrador | AGREGAR DETALLE DEPARTAMENTO </title> 
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-4"> 
                                ...
                                <form method="post" role="form" action="detalleDeptoAddServlet">
                                    <div class="form-group">

                                        <input type="hidden" name="idDepartamento" size="7" class="form-control" value="<c:out value="${idDepartamento}"></c:out>" hidden>  
                                    </div>
                                    <div class="form-group">
                                        <label for="cantDuctos">Nombre del Detalle</label>
                                        <input type="text" name="nomDetalle" size="4" class="form-control"/>
                                    </div>

                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary"><font size="1"><strong>AGREGAR DETALLE</strong></font></button>
